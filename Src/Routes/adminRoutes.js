...
import { confirmcharity,confirmPaymentAccountRequest, getAllCharityPaymentsMethods, getAllPendingRequestsCharities, getCharityPaymentsRequestsById, getPendingRequestCharityById, rejectcharity } from '../Controllers/adminController.js';
...
router.get('/requestPaymentMethod/:id',auth,isAdmin,confirmPaymentAccountRequest)
