...
import { resizeDocReq, uploadDocsReq } from '../../../../libraries/uploads/components/docs/images/handler2';
        ...
        async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                const changePasswordResponse =
                    await charityUseCase.changePassword(req, res, next);
        ...
        (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                const showCharityProfileResponse =
                    charityUseCase.showCharityProfile(req, res, next);
    ...
    router.put(
        ...
        async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                const changePasswordResponse =
                    await charityUseCase.editCharityProfile(req, res, next);
                return res.json(changePasswordResponse);
            } catch (error) {
                next(error);
                return undefined;
