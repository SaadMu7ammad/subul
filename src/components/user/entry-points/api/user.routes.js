    ...
    router.post(
        ...
        async (req, res, next) => {
            try {
                ...
                const resetResponse = await userUseCase.resetUser(
                    req,
                    res,
                    next
                );
        ...
        async (req, res, next) => {
            try {
                ...
                const activateAccountResponse =
                    await userUseCase.activateAccount(req, res, next);
    ...
    router.put(
        ...
        async (req, res, next) => {
            try {
                ...
                const editUserProfileResponse =
                    await userUseCase.editUserProfile(req, res, next);
