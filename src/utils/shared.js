...
const updateNestedPropertiesCharity = (target, updateObject) => {//target storedCharity, updateObj=newInput
  for (const key in updateObject) {
...
export { checkValueEquality, updateNestedProperties,updateNestedPropertiesCharity };
